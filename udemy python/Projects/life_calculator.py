...
#     exit()
# else:
#     print(f"your age in days is {age*year_length}")
#     print(f"User age in Hours is : {(age*year_length)*24}")
#     print(f"User age in Minutes is : {((age*year_length)*24)*60}")


# ---------> Above is mine code and below is instructors
